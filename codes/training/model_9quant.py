...
input_tensor=Input(shape=(40000,1))
...
dense_2=Dense(100,activation='relu',kernel_initializer='he_normal')(GRU_b)
output=Dense(10,activation='sigmoid',kernel_initializer='he_normal')(dense_2)
